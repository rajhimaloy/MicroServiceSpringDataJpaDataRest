...
public class PassengerControllerIntegrationTest {
    ...
    public void count(){
        //
        controller.insert(new Passenger("Rajib The Coder", Gender.MALE, 24));
        //
        Integer count = 121;
    ...
    public void query(){
        //
        controller.insert(new Passenger("Rajib The Coder", Gender.MALE, 24));
        controller.insert(new Passenger("Zepa The Pankha Coder", Gender.MALE, 24));
        controller.insert(new Passenger("Passang The Pagla", Gender.MALE, 26));
        //
